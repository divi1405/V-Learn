...
export default function LearningNeedsPage() {
    ...
    const canProceed = () => {
        switch (step) {
            ...
            case 2: return form.learning_goals.length > 10;
                ...
                <main className="main-content">
                    ...
                    {submitted && (
                        <div className="card card-accent" style={{ marginBottom: 24, textAlign: 'center' }}>
                            ...
                            <p style={{ color: 'var(--text-secondary)' }}>We'll use this to recommend the best courses for you.</p>
                        </div>
                    )}
                    ...
                    <div className="card" style={{ marginBottom: 16 }}>
                        ...
                        <div style={{ display: 'grid', gap: 16 }}>
                            <div>
                                <label style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 1 }}>Skill Level</label>
                                <p style={{ fontSize: '1rem', fontWeight: 600, textTransform: 'capitalize', marginTop: 4 }}>{data.current_skill_level}</p>
                            </div>
                            <div>
                                <label style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 1 }}>Areas of Interest</label>
                            ...
                            <div>
                                <label style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 1 }}>Learning Goals</label>
                                <p style={{ marginTop: 4, color: 'var(--text-secondary)', lineHeight: 1.6 }}>{data.learning_goals}</p>
                            </div>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                                <div>
                                    <label style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 1 }}>Preferred Format</label>
                                    <p style={{ marginTop: 4, fontWeight: 600 }}>{data.preferred_format}</p>
                                </div>
                                <div>
                                    <label style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 1 }}>Time Commitment</label>
            ...
            <main className="main-content">
                ...
                <div className="card lna-step">
                    {step === 0 && (
                        <div>
                            ...
                            <p style={{ color: 'var(--text-secondary)', marginBottom: 20 }}>This helps us recommend the right starting point</p>
                                ...
                                {SKILL_LEVELS.map(level => (
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: 4 }}>{level.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                    ...
                    {step === 1 && (
                        <div>
                            ...
                            <p style={{ color: 'var(--text-secondary)', marginBottom: 20 }}>Select all that apply</p>
                            <div className="checkbox-group">
                                {AREAS.map(area => (
                                    ...
                                    >
                                        <span>{form.areas_of_interest.includes(area) ? '☑️' : '⬜'}</span>
                                        {area}
                                    </div>
                                ))}
                            </div>
                    ...
                    {step === 2 && (
                        <div>
                            ...
                            <p style={{ color: 'var(--text-secondary)', marginBottom: 20 }}>Describe what you hope to achieve with AI learning</p>
                            <textarea
                    ...
                    {step === 3 && (
                        <div>
                            ...
                            <p style={{ color: 'var(--text-secondary)', marginBottom: 20 }}>How do you learn best?</p>
                            <div className="radio-group">
                                {FORMATS.map(f => (
                                    <div
                                        key={f}
                    ...
                    {step === 4 && (
                        <div>
                            ...
                            <p style={{ color: 'var(--text-secondary)', marginBottom: 20 }}>How much time can you dedicate each week?</p>
                            <div className="radio-group">
                                {TIME_OPTIONS.map(t => (
                                    <div
                                        key={t}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 24 }}>
                    ...
                    {step < STEPS.length - 1 ? (
                        ...
                        <button className="btn btn-primary" onClick={handleSubmit} disabled={!canProceed() || submitting}>
