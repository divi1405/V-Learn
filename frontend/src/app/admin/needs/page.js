                ...
                <div style={{ padding: '24px' }}>
                    <div className="page-header">
                        <h1 className="vearc-page-title" style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0, marginBottom: '8px' }}>
                            <TargetIcon style={{ color: 'var(--vearc-primary)' }} width="32" height="32" /> Learning Needs Analysis
                        </h1>
                        <p style={{ marginTop: 0 }}>Review what skills and formats your learners are requesting</p>
                    </div>
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    {filteredLnas.length === 0 ? (
                                        <tr><td colSpan="7" className="text-center" style={{ padding: 40, color: 'var(--vearc-text-muted)' }}>No data found</td></tr>
                                    ) : (
