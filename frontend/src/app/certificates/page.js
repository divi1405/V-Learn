...
const BADGE_LEVELS = [
    ...
    { level: 'Silver', icon: <MedalIcon width="32" height="32" style={{ color: 'var(--vearc-surface)' }} />, desc: 'Complete 3 courses', threshold: 3, className: 'silver' },
    { level: 'Gold', icon: <TrophyIcon width="32" height="32" style={{ color: 'var(--vearc-surface)' }} />, desc: 'Complete 5 courses', threshold: 5, className: 'gold' },
            ...
            <main className="main-content" style={{ padding: 0 }}>
                ...
                <div style={{ padding: '24px' }}>
                    <div className="page-header">
                        <h1 style={{ display: 'flex', alignItems: 'center', gap: 8 }}><TrophyIcon width="36" height="36" style={{ color: 'var(--vearc-primary)' }} /> Certificates & Badges</h1>
                    ...
                    <div style={{ marginBottom: 32 }}>
                        <div className="section-header">
                            <h2 style={{ display: 'flex', alignItems: 'center', gap: 8 }}><MedalIcon width="24" height="24" style={{ color: 'var(--vearc-primary)' }} /> Badges</h2>
                        </div>
