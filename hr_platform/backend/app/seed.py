...
def _do_seed():
    ...
    # --- Users ---
    admin = User(name="Alex Admin", email="admin@company.com", password_hash=hash_password("admin123"),
                 role=UserRole.ADMIN, department="IT", job_title="Platform Admin")
    hr = User(name="Hannah HR", email="hr@company.com", password_hash=hash_password("hr123"),
              role=UserRole.HR_ADMIN, department="Human Resources", job_title="HR Manager")
    learner1 = User(name="Sarah Kim", email="sarah@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Engineering", job_title="Software Engineer L3")
    learner2 = User(name="Tom Rodriguez", email="tom@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Engineering", job_title="Software Engineer L2")
    learner3 = User(name="Priya Mehta", email="priya@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Engineering", job_title="Software Engineer L3")
    learner4 = User(name="James Chen", email="james@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Product", job_title="Product Manager")
    learner5 = User(name="Emily Watson", email="emily@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Design", job_title="UX Designer")
    learner6 = User(name="Ravi Kumar", email="ravi@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Data Science", job_title="Data Scientist")
    learner7 = User(name="Lisa Park", email="lisa@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Engineering", job_title="ML Engineer")
    learner8 = User(name="Omar Hassan", email="omar@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Engineering", job_title="AI Research Intern")

    # --- Additional learners for rich leaderboard ---
    learner9 = User(name="Aisha Patel", email="aisha@company.com", password_hash=hash_password("learner123"),
                    role=UserRole.LEARNER, department="Sales", job_title="Sales Executive")
    learner10 = User(name="Daniel Wright", email="daniel@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Marketing", job_title="Marketing Analyst")
    learner11 = User(name="Sofia Garcia", email="sofia@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Finance", job_title="Financial Analyst")
    learner12 = User(name="Kevin Zhang", email="kevin@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Operations", job_title="Operations Manager")
    learner13 = User(name="Nina Thompson", email="nina@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Customer Support", job_title="Support Lead")
    learner14 = User(name="Marcus Brown", email="marcus@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Engineering", job_title="DevOps Engineer")
    learner15 = User(name="Yuki Tanaka", email="yuki@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Design", job_title="Product Designer")
    learner16 = User(name="Carlos Rivera", email="carlos@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Engineering", job_title="Backend Engineer")
    learner17 = User(name="Rachel Adams", email="rachel@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Legal", job_title="Compliance Analyst")
    learner18 = User(name="Hassan Ali", email="hassan@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Data Science", job_title="ML Research Engineer")
    learner19 = User(name="Megan Taylor", email="megan@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Product", job_title="Product Lead")
    learner20 = User(name="Andre Jackson", email="andre@company.com", password_hash=hash_password("learner123"),
                     role=UserRole.LEARNER, department="Sales", job_title="Account Manager")
