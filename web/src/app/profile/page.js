                    ...
                    {user.role !== 'ADMIN' && user.role !== 'HR_ADMIN' && (<>
                        ...
                        {badges.length > 0 && (
                            <div style={{ marginBottom: 24 }}>
                                <div className="section-header"><h2 style={{ display: 'flex', alignItems: 'center', gap: 8 }}><BookIcon width="24" height="24" style={{ color: '#1a1a1a' }} /> My Badges</h2></div>
                                <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                                    {badges.map(b => (
                                        <div key={b.id} className="card" style={{ minWidth: 200, flex: 1, textAlign: 'center', padding: '24px 16px', borderTop: `4px solid ${b.level === 'bronze' ? '#cd7f32' : b.level === 'silver' ? '#c0c0c0' : b.level === 'gold' ? '#ffd700' : '#333'}` }}>
